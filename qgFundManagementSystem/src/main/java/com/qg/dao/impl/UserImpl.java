...
public class UserImpl implements UserDao {
    ...
    public List<User> findById(Long userId) {
        String sql = "SELECT `user_id`, `username`, `nickname`, `password_hash`, `email`, `phone_number`, `avatar_url`, `gmt_create`, `gmt_modified` FROM `users` WHERE `user_id` = ?";
    ...
    public List<User> findAll() {
        String sql = "SELECT `user_id`, `username`, `nickname`, `password_hash`, `email`, `phone_number`, `avatar_url`, `gmt_create`, `gmt_modified` FROM `users`";
        Connection connection = ConnectionPoolManager.getConnection();
        PreparedStatement preparedStatement = null;
    ...
    public Long save(User user) {
        String sql = "INSERT INTO `users` (`username`, `nickname`, `password_hash`, `email`, `phone_number`, `avatar_url`, `gmt_create`, `gmt_modified`) VALUES "
                + "(?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        return CRUDUtils.save(sql, userName, nickname, passwordHash, email, phoneNumber, avatarUrl, gmtCreate, gmtModified);
    }
    ...
    public void update(User user) {
        ...
        String gmtCreate = user.getGmtCreate();
        String gmtModified = user.getGmtModified();
        CRUDUtils.update(sql, userName, nickname, passwordHash, email, phoneNumber, avatarUrl, gmtCreate, gmtModified, userId);
    }
    ...
    public List<User> findByLikeUsername(String userName) {
        userName = "%" + userName + "%";
        String sql = "SELECT `user_id`, `username`, `nickname`, `password_hash`, `email`, `phone_number`, `avatar_url`, `gmt_create`, `gmt_modified` FROM `users` WHERE `username` LIKE ?";
        Connection connection = ConnectionPoolManager.getConnection();
        PreparedStatement preparedStatement = null;
